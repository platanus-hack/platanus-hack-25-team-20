...
import { cvService, submissionService, jobService } from "@/services";
...
export default function Editor() {
  ...
  >([
    {
      role: "ai",
      content:
        "Hi! I can help you customize your CV for this position. What would you like to change?",
    },
  ]);
  ...
  useEffect(() => {
    async function loadCV() {
      ...
      try {
        ...
        if (
          cvData.conversation_history &&
          Array.isArray(cvData.conversation_history)
        ) {
    ...
    try {
      ...
      setChatHistory([
        ...
        userMessage,
        {
          role: "ai",
          content:
            "I've updated your CV based on your request. Please review the changes on the right.",
        },
      ]);
    } catch (error) {
      ...
      setChatHistory([
        ...
        userMessage,
        {
          role: "ai",
          content:
            "Sorry, I encountered an error while updating your CV. Please try again.",
        },
      ]);
    } finally {
  ...
  const handleSubmit = async () => {
    if (!cv || !jobOfferingId) {
      toast({
        title: "Error",
        description: "Missing CV or job information",
        variant: "destructive",
      });
      return;
    }
    ...
    try {
      ...
      // Fetch the job offering to get the URL
      const job = await jobService.getById(jobOfferingId);
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Customize your CV with AI assistance
              </p>
            </div>
          </div>
        ...
        <div className="border-r border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950 flex flex-col">
          ...
          <div className="p-4 border-t border-gray-200 dark:border-gray-800">
            <div className="flex gap-2">
              <Textarea
                placeholder={
                  regenerating ? "Generating..." : "Ask AI to modify your CV..."
                }
