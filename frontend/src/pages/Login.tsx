        ...
        <div className="relative z-10 max-w-lg text-white space-y-8">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Automatically tailor your CV to match job requirements
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Beat ATS systems and get more interview calls
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-white/80">
                    Monitor applications and optimize your strategy
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="pt-6 border-t border-white/20">
            <p className="text-sm text-white/70">
              Trusted by{" "}
              <span className="font-semibold text-white">10,000+</span> job
              seekers worldwide
            </p>
          </div>
        </div>
              ...
              <div className="relative">
                <Input
                  ...
                  className={`pr-10 transition-fast ${
                    emailValid
                      ? "border-accent-mint focus:ring-accent-mint"
                      : ""
                  }`}
                />
                {emailValid && (
